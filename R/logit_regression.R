logit_regression <- function(X, y,  tol = 1e-16, beta_start = NULL, maxiter=10000){
  ...
  for(t in 2:maxiter){
    ...
    if(loglik[t] - loglik[t-1] < tol) return(list(par=beta, Convergence=cbind(Iteration=(1:t)-1,
