...
As computing the expected value for this quantity can be demanding, `sdm` function simply computes $k/\mathbb{E}(K_\infty \mid K_n = k)$, which is a first approximation. To extract the quantites, just run:
